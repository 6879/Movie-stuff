                                    ...
                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="center"> First Episode Date</th>
                                                <th class="center"> Action </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($viw as $input)
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    <a href="edittvshows&{{$input->id}}" class="btn btn-tbl-edit btn-xs">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a   onclick="return confirm('Are you sure to delete this post? ')"   href="deletetvshows&{{ $input->id}}" class="btn btn-tbl-delete btn-xs">
