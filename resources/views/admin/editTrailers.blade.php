                        ...
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                               ...
                               <div class="card-body row">
                                <form action="edittrailers&{{$input->id}}" method="post" enctype="multipart/form-data">
                         {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-6 p-t-20"> 
                                      <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                         <input  value="{{$input->type}}"  class = "mdl-textfield__input" name="type" type = "text" id = "txtRoomNo">
                                    ...
                                    <div class="col-lg-6 p-t-20"> 
                                      ...
                                      <div class="col-lg-6 p-t-20"> 
                                      <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                         <input  value="{{$input->durition}}"  class = "mdl-textfield__input" name="durition" type = "text" id = "txtRoomNo">
